...
public class JInterval extends ArithmeticLibrarySpecification {
	private static final String OPTION_NAME = "jint";
	private static final String LIBRARY_NAME = "JInterval Default";

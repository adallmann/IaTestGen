...
public class Jintexact extends TestCase {
	...
	public void test_06_mul()
	{
		...
		RealInterval input_02 = RealInterval.valueOf(Rational.valueOf(input_02_lower), Rational.valueOf(input_02_upper));
		// expected output parameter 1:
		float output_lower = Hex.toFloat("0x41200000");
		float output_upper = Hex.toFloat("0x41F00000");
		RealInterval output = RealInterval.valueOf(Rational.valueOf(output_lower), Rational.valueOf(output_upper));
		
		// operation to test: mul
		RealInterval lib_output = input_01.multiply(input_02);	
		// assert function for output 1:
		float lo_output = output.exactInf().floatValue();
		float lo_lib_output = lib_output.exactInf().floatValue();
		assertTrue(lo_lib_output == lo_output);
		float hi_output = output.exactSup().floatValue();
		float hi_lib_output = lib_output.exactSup().floatValue();
		assertTrue(hi_lib_output == hi_output);
	...
	public void test_07_mul()
	{
		...
		RealInterval input_02 = RealInterval.valueOf(Rational.valueOf(input_02_lower), Rational.valueOf(input_02_upper));
		// expected output parameter 1:
		double output_lower = Hex.toDouble("0x4024000000000000");
		double output_upper = Hex.toDouble("0x403E000000000000");
		RealInterval output = RealInterval.valueOf(Rational.valueOf(output_lower), Rational.valueOf(output_upper));
